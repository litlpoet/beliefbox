...
*/
real ConditionalKDContextTree::Node::Observe(Vector& x, Vector& y,
                                             real probability) {
...
*/
real ConditionalKDContextTree::Node::pdf(Vector& x, Vector& y,
                                         real probability) {
  real total_probability;
...
ConditionalKDContextTree::~ConditionalKDContextTree() { delete root; }
...
int ConditionalKDContextTree::NChildren() { return root->NChildren(); }
