...
class GaussianProcess {
 ...
 public:
  GaussianProcess(Matrix& Sigma_p_, real noise_variance_);
  GaussianProcess(real noise_variance_, Vector scale_length_, real hyp_u_);
  GaussianProcess(Matrix& X_, Vector& Y_, real noise_variance_,
                  real scale_length_, real hyp_u_);
