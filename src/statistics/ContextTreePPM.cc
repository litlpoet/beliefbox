...
ContextTreePPM::Node::Node(int n_branches_, int n_outcomes_)
 ...
 */
real ContextTreePPM::Node::Observe(Ring<int>& history, Ring<int>::iterator x,
                                   int y, real probability, Vector* P_prev) {
...
ContextTreePPM::~ContextTreePPM() { delete root; }
...
int ContextTreePPM::NChildren() { return root->NChildren(); }
