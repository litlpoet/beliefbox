...
static const char* const help_text =
    "Usage bayesian multivariate regression [options] \n\
\nOptions: \n\
...
int main(int argc, char* argv[]) {
  ...
  if (b_functions == 1) {
    ...
    std::cout << "# Number of basis functions: " << (RBFs->size() + 1)
              << std::endl;
  }
  ...
  // if (argc != 6) {
  //    fprintf(stderr, "Usage: Bayesian Multivariate Regression points
  // dimensions a N_0\n");
  //    exit(-1);
  //  }
  ...
  //
  //
  //  BayesianMultivariateRegression bmr(n_dimensions_x, n_dimensions_y, N0 *
  // Matrix::Unity(n_dimensions_y, n_dimensions_y), N0, a);
  //  std::auto_ptr<Distribution> distribution_x(new
