...
class DiscreteHiddenMarkovModelEM {
 ...
 public:
  DiscreteHiddenMarkovModelEM(int n_states_, int n_observations_,
                              real stationarity, RandomNumberGenerator* rng,
                              int n_iter_ = 1)
      : n_states(n_states_), n_observations(n_observations_), B(n_states) {
