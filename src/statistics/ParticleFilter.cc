/* -*- Mode: C++; -*- */
/* VER: $Id: ParticleFilter.c,v 1.2 2006/11/06 18:28:10 cdimitrakakis Exp
 * cdimitrakakis $*/
...
ParticleFilter::ParticleFilter(int N, Distribution* prior, Distribution* T,
                               Distribution* O) {
  this->transitions = T;
  this->observations = O;
  this->prior = prior;
...
void ParticleFilter::Init(int N, Distribution* prior, Distribution* T,
                          Distribution* O) {
  this->transitions = T;
  this->observations = O;
  this->prior = prior;
...
/// The problem is that ..
BernoulliParticleFilter::BernoulliParticleFilter(int N, Distribution* prior,
                                                 Distribution* T,
                                                 Distribution* O)
    : ParticleFilter(N, prior, T, O) {}
...
BernoulliGridParticleFilter::BernoulliGridParticleFilter(int N,
                                                         Distribution* prior,
                                                         Distribution* T,
                                                         Distribution* O)
    : ParticleFilter(N, prior, T, O) {}
