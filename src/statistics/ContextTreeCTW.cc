...
ContextTreeCTW::Node::Node(int n_branches_, int n_outcomes_)
...
real ContextTreeCTW::Node::Observe(Ring<int>& history, Ring<int>::iterator x,
                                   int y, real probability) {
...
ContextTreeCTW::~ContextTreeCTW() { delete root; }
...
int ContextTreeCTW::NChildren() { return root->NChildren(); }
