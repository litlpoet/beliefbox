...
ContextTreeBMC::Node::Node(int n_branches_, int n_outcomes_,
...
real ContextTreeBMC::Node::Observe(Ring<int>& history, Ring<int>::iterator x,
...
ContextTreeBMC::~ContextTreeBMC() { delete root; }
...
int ContextTreeBMC::NChildren() { return root->NChildren(); }
