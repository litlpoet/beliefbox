...
void DiscreteTransitionDistribution::SetTransition(int state, int action,
                                                   int next_state,
                                                   real probability) {
...
real DiscreteTransitionDistribution::GetTransition(int state, int action,
...
real DiscreteTransitionDistribution::pdf(int state, int action,
                                         int next_state) const {
