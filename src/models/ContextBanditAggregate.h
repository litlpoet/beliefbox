...
class ContextBanditAggregate : public ContextBanditGaussian {
 ...
 public:
  ContextBanditAggregate(int n_aggregated_states, int n_states, int n_actions,
                         real tau, real mu_0, real tau_0);
  ContextBanditAggregate(bool blah, int n_factors, int n_values,
                         int n_aggregated_states, int n_states, int n_actions,
                         real tau, real mu_0, real tau_0);
