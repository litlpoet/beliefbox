...
class DiscretePOMDP {
 ...
 public:
  ...
  void setObservation(int x) { observation = x; }
  void setReward(real r) { reward = r; }
  void setState(int s) { state = s; }

  // get information about the POMDP
  int getNStates() { return n_states; }
  int getNActions() { return n_actions; }
  int getNObservations() { return n_obs; }
  ...
  void setObservationProbability(int state, int action, int observation,
                                 real p) {
