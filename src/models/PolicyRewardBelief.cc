...
/// Create teh blief
PolicyRewardBelief::PolicyRewardBelief(real lambda, real gamma_,
...
FixedDiscretePolicy* PolicyRewardBelief::CalculatePosterior(
    Demonstrations<int, int>& D) {
  return NULL;
}

/// Calculate  $log P(a^T \mid s^T, \pi)$
real PolicyRewardBelief::logLikelihood(
