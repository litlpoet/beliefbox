// -*- Mode: c++ -*-
// copyright (c) 2007-2011 by Christos Dimitrakakis
...
class GoalStateRewardDistribution : public RewardDistribution<int, int> {
 ...
 public:
  GoalStateRewardDistribution(real default_reward_, int goal_state_,
                              real goal_reward_);
...
class DiscreteSpaceRewardDistribution : public RewardDistribution<int, int> {
 ...
 public:
  ...
  DiscreteSpaceRewardDistribution& operator=(
  ...
  void Show();
  Vector getExpectedRewardVector() const { return ER; }
};
