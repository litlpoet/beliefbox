...
ContextBanditGaussian::ContextBanditGaussian(int n_states, int n_actions,
...
real ContextBanditGaussian::getTransitionProbability(int s, int a,
                                                     int s2) const {
