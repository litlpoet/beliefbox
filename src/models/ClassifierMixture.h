...
class LinearClassifierMixture : public Classifier<Vector, int, Vector> {
 public:
  ...
  Vector output;
  real alpha;
  LinearClassifierMixture(int n_inputs_, int n_classes_, int n_classifiers,
                          int projection_size);
...
class HashedLinearClassifierMixture : public LinearClassifierMixture {
 ...
 public:
  HashedLinearClassifierMixture(int n_inputs_, int n_classes_,
...
class HashedClassifierMixture {
 ...
 public:
  Vector output;
  HashedClassifierMixture(int n_inputs_, int n_classes_,
  ...
  int Classify(Vector& x) { return ArgMax(Output(x)); }
