/* -*- Mode: C++; -*- */
/* VER: $Id: test_switching_strategies.c,v 1.1 2006/10/31 16:59:39 cdimitrakakis
 * Exp cdimitrakakis $*/
...
int main(int argc, char** argv) {
  fprintf(stderr,
          "test_pf_evaluation $Id: test_switching_strategies.c,v 1.1 "
          "2006/10/31 16:59:39 cdimitrakakis Exp cdimitrakakis $\n");
  if (argc != 4) {
