/* -*- Mode: C++; -*- */
/* VER: $Id: test_bernoulli_estimate.c,v 1.3 2006/10/21 20:03:01 olethros Exp
 * cdimitrakakis $*/
...
int main(int argc, char** argv) {
  ...
  for (int i = 0; i < n_iters; i++) {
    ...
    printf("%f %f %f %f %f\n", Ex, population_estimate.GetMean(0),
           population_estimate2.GetMean(0), pf_estimate.GetMean(0),
