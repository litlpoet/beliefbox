...
RandomMDP::RandomMDP(uint n_actions_, uint n_states_, real randomness_,
                     real step_value_, real pit_value_, real goal_value_,
                     RandomNumberGenerator* rng, bool termination_)
...
RandomMDP::~RandomMDP() { delete mdp; }
