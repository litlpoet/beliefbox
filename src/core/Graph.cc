...
/**
   ...
   \arg \c C Constraint vector. If not NULL, then all non-zero entries mean that
   the algorithm will ignore all corresponding nodes.
...
int Graph::n_edges(int i) { return n_edges(1); }
