...
class ConnectivityMatrix : public Graph {
 ...
 public:
  /** \brief Create a matrix with N nodes, directional, with an optional list of
   * prior connections and optional inversion of directions.
   */
  ConnectivityMatrix(int N, bool directional, int** c = NULL,
                     bool invert = false, real** d = NULL);
