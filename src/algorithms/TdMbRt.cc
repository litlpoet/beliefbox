...
TdMbRt::TdMbRt(const int n_states_, const int n_actions_, const real gamma_,
...
real TdMbRt::Observe(const int state, const int action, const real reward,
  ...
  LAMBDA(state, action) = ((double)(max - min)) / ((double)(TOTAL * (1 + U)));
...
real TdMbRt::Observe(const real reward, const int next_state,
...
int TdMbRt::Act(const real reward, const int next_state) {
