...
c = 1;
K = 10;
plot(moving_average(Sarsa(
                        :, c),
                    K),
     ";Sarsa;", moving_average(QLearning(
                                   :, c),
                               K),
     ";Q-learning;", moving_average(Model(
                                        :, c),
                                    K),
     ";Model;", moving_average(Sampling1(
                                   :, c),
                               K),
     ";Sampling1;", moving_average(Sampling2(
                                       :, c),
                                   K),
     ";Sampling2;");
