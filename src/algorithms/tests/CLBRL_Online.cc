...
Statistics TrainingAlgorithm(real gamma, int episode_steps, int n_episodes,
...
int main(int argc, char* argv[]) {
  ...
  //	CoverFittedValueIteration<Vector,int> *FVI = new
  // CoverFittedValueIteration<Vector,int>(gamma, 2000, 5, environment, cover);

  std::cout << "Fitted LSTD initialization..." << std::endl;
  CoverFittedLSTD<Vector, int>* FLSTD = new CoverFittedLSTD<Vector, int>(
      gamma, n_samples, 1, environment, cover, grids, scale);
  //	CoverFittedLSTD<Vector,int> *FLSTD = new
  // CoverFittedLSTD<Vector,int>(gamma, 3000, 1, environment, cover);
  //	CoverFittedLSTD<Vector,int> *FLSTD = NULL;

  //	CoverFittedLSTDQ<Vector,int> *FLSTDQ = new
  // CoverFittedLSTDQ<Vector,int>(gamma, 5000, 1, environment, cover, 4, 1.0);
  //	CoverFittedLSTDQ<Vector,int>* FLSTDQ = new
  // CoverFittedLSTDQ<Vector,int>(gamma, 3000, 1, environment, cover);
  ...
  CoverBayesianMultivariate* algorithm = new CoverBayesianMultivariate(
      n_actions, gamma, epsilon, cover, FVI, FLSTD, FLSTDQ);
  ...
  Statistics run_statistics =
      TrainingAlgorithm(gamma, episode_steps, episodes, algorithm, environment);
