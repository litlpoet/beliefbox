...
void TestModel(const DiscreteMDP* mdp, const int max_iter, const real threshold,
               const bool relative, const char* fname);
...
int main(void) {
  ...
  }
  {
    ...
    printf("\nRelative value iteration\n");
    TestModel(&mdp, max_iter, threshold, true,
              "example_8_5_2_aperiodic_relative.dot");
  }
  {
    ...
    printf("\nRelative value iteration\n");
    TestModel(&mdp, max_iter, threshold, true,
              "example_9_5_1_aperiodic_relative.dot");
  }
...
void TestModel(const DiscreteMDP* mdp, const int max_iter, const real threshold,
  ...
  // GoalStateIteration goal_state_iteration(mdp);
  real diameter =
      5.0;  // goal_state_iteration.GetMDPDiameter(threshold, max_iter);
