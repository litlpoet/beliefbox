...
UCB1Policy::UCB1Policy(int n_actions_) : n_actions(n_actions_) { Reset(); }
...
void UCB1Policy::SetTimes(int a, int times_) { times[a] = times_; }

void UCB1Policy::SetReward(int a, real reward) { Er[a] = reward; }
...
void UCBgPolicy::SetTimes(int a, int times_) { times[a] = times_; }

void UCBgPolicy::SetReward(int a, real reward) { Er[a] = reward; }

UCB2Policy::UCB2Policy(int n_actions_) : n_actions(n_actions_) { Reset(); }
...
int UCB2Policy::SelectAction() { return ArgMax(n_actions, &U[0]); }
