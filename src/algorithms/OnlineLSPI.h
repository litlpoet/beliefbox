...
class OnlineLSPI {
 ...
 public:
  OnlineLSPI(real gamma_, real Delta_, int n_dimension_, int n_actions_,
  ...
  void LSTD(const Vector& state, const int& action, const real& reward,
  ...
  void LSTDQ(const Vector& state, const int& action, const real& reward,
             const Vector& state_, const int& action_, const bool& endsim,
             const bool& update = true);
  void LSTDQ_OPT(const Vector& state, const int& action, const real& reward,
                 const Vector& state_, const int& action_, const bool& endsim,
                 const bool& update = true);
  void Reset();
  void Update();
