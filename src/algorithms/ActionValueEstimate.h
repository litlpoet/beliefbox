/* -*- Mode: C++; -*- */
/* VER: $Id: ActionValueEstimate.h,v 1.4 2006/10/23 08:33:24 olethros Exp
 * cdimitrakakis $*/
...
class ActionValueEstimate {
 public:
  ...
  virtual real GetProbability(int i, int j, real delta) { return 0.0f; }
};
...
class BernoulliEstimate : public ActionValueEstimate {
 public:
  ...
  BernoulliEstimate(int n_actions, int n_samples, real alpha = 1.0,
                    real beta = 1.0);
  /// Destroy
