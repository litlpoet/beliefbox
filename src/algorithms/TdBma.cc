...
TdBma::TdBma(const int n_states_, const int n_actions_, const real gamma_,
...
real TdBma::Observe(const int state, const int action, const real reward,
...
real TdBma::Observe(const real reward, const int next_state,
