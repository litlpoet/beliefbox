...
class BVMM_QLearning : public OnlineAlgorithm<int, int> {
 ...
 public:
  BVMM_QLearning(int n_actions_, int n_obs_, int depth, real epsilon_,
                 real alpha_, real gamma_)
  ...
  ///
  virtual real getValue(int state, int action) { return QValue(action); }
